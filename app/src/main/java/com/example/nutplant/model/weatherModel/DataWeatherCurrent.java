...
public class DataWeatherCurrent {
    ...
    @Expose
    private DataWeatherCondition condition;
    ...
    public DataWeatherCondition getCondition() {
        return condition;
    }
    public void setCondition(DataWeatherCondition condition) {
